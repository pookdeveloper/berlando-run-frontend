...
export const metadata: Metadata = {
  title: "Run Clubs - Belando Run",
  description:
    "Join weekly group runs across Europe. Madrid, Barcelona, Paris, Berlin, and London.",
};
      ...
      <div className="border-b border-border">
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <p className="mt-6 max-w-2xl text-lg text-foreground/70">
            Join our community run clubs across Europe. All paces welcome, from
            beginners to experienced trail runners.
          </p>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {clubs.map((club) => (
            ...
            >
              <h3 className="text-2xl font-light text-card-foreground">
                {club.city}
              </h3>
              ...
              <div className="mt-6 space-y-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-card-foreground/70">
                      {club.members} members · {club.pace}
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="mt-24 border-t border-border pt-16">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-6 text-lg text-foreground/70">
              Want to organize a run club in your city? We support community-led
              initiatives with gear, resources, and guidance.
            </p>
            <div className="mt-8">
              <Link
                href="/contact"
