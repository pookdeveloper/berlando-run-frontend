...
export const metadata: Metadata = {
  title: "Returns - Belando Run",
  description: "Return policy and instructions for Belando Run products.",
};
          ...
          <div className="mt-16 space-y-12">
              ...
              <div className="mt-6 space-y-6">
                <div>
                  ...
                  <p className="mt-2 text-lg text-foreground/70">
                    Contact us at{" "}
                    <a href="mailto:returns@belando.run" className="underline">
                      returns@belando.run
                    </a>{" "}
                    with your order number and reason for return. We'll send you
                    a return label.
                  </p>
                </div>
                <div>
                  ...
                  <p className="mt-2 text-lg text-foreground/70">
                    Place items in original packaging (or any secure packaging).
                    Include a note with your order number and email address.
                  </p>
                </div>
                <div>
                  <h3 className="font-mono text-sm uppercase tracking-wider text-muted-foreground">
                  ...
                  <p className="mt-2 text-lg text-foreground/70">
                    Attach the return label we sent you and drop off at any
                    authorized carrier location.
                  </p>
                </div>
                <div>
                  <h3 className="font-mono text-sm uppercase tracking-wider text-muted-foreground">
            ...
            <section className="border-t border-border pt-12">
              ...
              <div className="mt-6 space-y-4 text-lg leading-relaxed text-foreground/70">
                ...
                <p>
                  Exchanges are subject to availability. If your preferred item
                  is out of stock, we'll process a refund instead.
                </p>
              </div>
            </section>
            ...
            <section className="border-t border-border pt-12">
              ...
              <div className="mt-6 space-y-4 text-lg leading-relaxed text-foreground/70">
                <p>
                  <strong>Free Returns:</strong> Return shipping is free for all
                  EU orders.
                </p>
                <p>
                  <strong>UK Orders:</strong> Return shipping costs €10, which
