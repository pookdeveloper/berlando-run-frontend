        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          {!LANDING_MODE && (
            <div className="space-y-4">
              ...
              <nav className="flex flex-col space-y-3 text-sm text-muted-foreground">
                ...
                <Link href="/products?category=trail-shorts" className="hover:text-foreground transition-colors">Trail Shorts</Link>
                <Link href="/products?category=technical-tees" className="hover:text-foreground transition-colors">Technical Tees</Link>
                <Link href="/products?category=outerwear" className="hover:text-foreground transition-colors">Outerwear</Link>
              </nav>
            </div>
          )}
          ...
          {!LANDING_MODE && (
            <div className="space-y-4">
              ...
              <nav className="flex flex-col space-y-3 text-sm text-muted-foreground">
                <Link href="/community/run-clubs" className="hover:text-foreground transition-colors">Run Clubs</Link>
                <Link href="/community/events" className="hover:text-foreground transition-colors">Events</Link>
                <Link href="/community/challenges" className="hover:text-foreground transition-colors">Challenges</Link>
