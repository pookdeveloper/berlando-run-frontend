...
async function main() {
  ...
  const alphaShort = await prisma.product.create({
    data: {
      ...
      description:
        "Ultralight trail running short with 4-way stretch and laser ventilation. Built for long-distance mountain running.",
      price: 98.0,
      category: ProductCategory.TRAIL_SHORTS,
      productStory:
        "Designed in collaboration with ultrarunners in the French Alps. The Alpha Short emerged from 1,000+ hours of testing on technical terrain.",
      materialStory:
        "Constructed from Japanese ripstop nylon with 4-way stretch. DWR coating sheds water. Laser-cut ventilation zones regulate temperature.",
      weight: 85,
      material: "Nylon ripstop with elastane",
      temperature: "-5°C to 30°C",
      featured: true,
      useCases: [
        ProductUseCase.LONG_DISTANCE,
        ProductUseCase.TECHNICAL_TERRAIN,
        ProductUseCase.HOT_WEATHER,
      ],
      images: {
        create: [
          {
  ...
  const velocityTee = await prisma.product.create({
    data: {
      ...
      description:
        "Featherweight merino blend tee with anti-odor technology. Seamless construction for zero chafing.",
      price: 78.0,
      category: ProductCategory.TECHNICAL_TEES,
      productStory:
        "The Velocity Tee is the result of obsessive refinement. We tested 47 fabric combinations before landing on this merino-synthetic hybrid.",
      materialStory:
        "60% merino wool, 40% recycled polyester. Offset shoulder seams eliminate pressure points. Reflective logo for low-light visibility.",
      weight: 110,
    ...
    data: [
      {
        ...
        longitude: -3.7038,
        description:
          "Weekly trail runs in the Sierra de Guadarrama. All paces welcome.",
        meetingDay: "Saturday",
        meetingTime: "07:00",
      ...
      },
      {
        ...
        longitude: 2.1734,
        description:
          "Technical trail running in Collserola Natural Park. Sunrise runs every Wednesday.",
      ...
      },
      {
        ...
        longitude: 2.3522,
        description:
          "Exploring the city through running. Urban trails, stairs, and hidden passages.",
        meetingDay: "Sunday",
        meetingTime: "08:00",
      ...
      },
      {
        ...
        longitude: 13.405,
        description:
          "Long-distance training runs. Grunewald Forest and beyond.",
        meetingDay: "Saturday",
        meetingTime: "07:30",
      ...
      },
      {
        ...
        longitude: -0.1278,
        description:
          "Running as freedom. Hampstead Heath, Richmond Park, and city exploration.",
        meetingDay: "Friday",
        meetingTime: "06:00",
    ...
    data: [
      {
        ...
        description:
          "Start before dawn, summit at sunrise. 15km trail run with 800m elevation gain in the Sierra de Guadarrama mountains outside Madrid.",
        location: "Navacerrada, Spain",
        date: new Date("2026-04-15T05:30:00Z"),
        image: "https://images.unsplash.com/photo-1506905925346-21bda4d32df4",
        registrationUrl: "https://belando.run/events/sunrise-summit-guadarrama",
      },
      {
        ...
        description:
          "3-day trail running immersion in Chamonix. Technical skills, long runs, and mountain culture. Limited to 20 participants.",
        location: "Chamonix, France",
        date: new Date("2026-06-12T08:00:00Z"),
        image: "https://images.unsplash.com/photo-1464822759023-fed622ff2c3b",
        registrationUrl: "https://belando.run/events/trail-weekend-alps",
      },
      {
        ...
        description:
          "20km through Berlin's hidden trails, abandoned places, and urban wilderness. Discover the city differently.",
        location: "Berlin, Germany",
        date: new Date("2026-05-08T06:00:00Z"),
        image: "https://images.unsplash.com/photo-1560969184-10fe8719e047",
        registrationUrl: "https://belando.run/events/berlin-urban-exploration",
      },
    ],
  });
    ...
    data: [
      {
        ...
        description:
          "Run 200 kilometers in March. Track your progress, share your routes, and connect with runners worldwide pushing their limits.",
        type: "distance",
        target: 200,
        unit: "km",
      ...
      },
      {
        ...
        description:
          "Climb 1,000 meters of elevation in a single run. Technical trails, steep climbs, summit pushes. One month to complete.",
        type: "elevation",
        target: 1000,
        unit: "meters",
    ...
    data: [
      {
        ...
        excerpt:
          "Why we run. Not for medals or times, but for the feeling of movement, the sense of exploration, the experience of being fully present.",
        content:
          "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Running is not about racing. It's about freedom...",
      ...
      },
      {
        ...
        excerpt:
          "A complete guide to one of Europe's most challenging long-distance trails. Technical terrain, stunning views, and lessons learned.",
        content:
          "Lorem ipsum dolor sit amet, consectetur adipiscing elit. The GR20 traverses Corsica from north to south...",
      ...
      },
      {
        ...
        excerpt:
          "The legendary mountain runner shares his philosophy on gear, training, and why less is more in ultrarunning.",
        content:
          'Lorem ipsum dolor sit amet, consectetur adipiscing elit. "I don\'t need much," Kilian says...',
